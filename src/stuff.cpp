...
const StringMap musicNames ({
    ...
    {0x16, "16: Quick Draw (SFX)"},
    {0x17, "17: Silence"},
    {0x18, "18: Quick Draw (SFX)"},
    {0x19, "19: Quick Draw (SFX)"},
    {0x1A, "18: Quick Draw (I)ntro"},
    {0x1B, "1B: Rainbow Resort"},
    {0x1C, "1C: Rainbow Resort (no intro)"},
    {0x1D, "1D: Quick Draw (Foul)"},
    {0x1E, "1E: Yogurt Yard"},
    ...
    {0x2E, "2E: Minigame (No Bonus)"},
    {0x2F, "2F: Minigame (Perfect)"},
    {0x30, "30: Minigame (Bonus)"},
    {0x31, "31: Title Intro"},
    {0x32, "32: Butter Building"},
    {0x33, "33: Butter Building (no intro)"},
    {0x34, "34: Nightmare Orb Appears"},
    {0x35, "35: Title Theme"},
    {0x36, "36: Museum / Warp Star"},
    {0x37, "37: Ending"},
    {0x38, "38: Fountain of Dreams"},
    {0x39, "39: Nightmare Orb"}
});
