...
const StringMap tileTypes ({
    ...
    {0x1d, "1D: breakable"},
    {0x1e, "1E: breakable with ability(?)"},
    {0x1f, "1F: breakable with ability(?)"},
    {0x20, "20: bomb"},
    {0x21, "21: bomb chain"},
    ...
    // 60 - 7e = ??
    {0x60, "60: ice"},
    {0x61, "61: ice, press down to drop"},
    {0x62, "62: ice (?)"},
    ...
    {0x6f, "6F: ice breakable(?)"},
    {0x70, "70: ice breakable with ability(?)"},
    {0x71, "71: ice breakable with ability(?)"},
    {0x72, "72: ice spikes"},
